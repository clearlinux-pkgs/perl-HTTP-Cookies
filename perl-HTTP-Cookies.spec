...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Cookies-6.11.tar.gz
...
%prep
%setup -q -n HTTP-Cookies-6.11
cd %{_builddir}/HTTP-Cookies-6.11
...
cp %{_builddir}/HTTP-Cookies-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Cookies/88ce42a07fddbb5aeae1b0b1b3036e1d812e4d85 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-HTTP-Cookies/88ce42a07fddbb5aeae1b0b1b3036e1d812e4d85
