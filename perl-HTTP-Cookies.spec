...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Cookies-6.07.tar.gz
...
%prep
%setup -q -n HTTP-Cookies-6.07
cd %{_builddir}/HTTP-Cookies-6.07
...
cp %{_builddir}/HTTP-Cookies-6.07/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Cookies/c3a2b1cf1377a53ad9d3e9b94b761cd1cabe2cae
if test -f Makefile.PL; then
