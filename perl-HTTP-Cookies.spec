...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/HTTP-Cookies-6.08.tar.gz
...
%prep
%setup -q -n HTTP-Cookies-6.08
cd %{_builddir}/HTTP-Cookies-6.08
...
cp %{_builddir}/HTTP-Cookies-6.08/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Cookies/c3a2b1cf1377a53ad9d3e9b94b761cd1cabe2cae
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-HTTP-Cookies/c3a2b1cf1377a53ad9d3e9b94b761cd1cabe2cae

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.2/HTTP/Cookies.pm
/usr/lib/perl5/vendor_perl/5.30.2/HTTP/Cookies/Netscape.pm
