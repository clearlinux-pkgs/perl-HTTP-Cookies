...
cp %{_builddir}/HTTP-Cookies-6.05/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTTP-Cookies/8d6e0b564495c0902e07259e61ef783c8fa9617f
if test -f Makefile.PL; then
